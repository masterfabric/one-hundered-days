        ...
        child: Column(
          ...
          children: [
            ...
            _FeatureCard(
              ...
              title: t.homeFeatureRecipe,
              description: t.homeFeatureRecipeDesc,
              color: const Color(0xFFFF8F00),
              onTap: () => viewModel.navigate('/recipe-engine'),
              theme: theme,
            ),
            OsmeaComponents.sizedBox(height: context.spacing16),
            _FeatureCard(
              icon: Icons.dynamic_feed_outlined,
              title: t.homeFeatureRecipeFeed,
              description: t.homeFeatureRecipeFeedDesc,
              color: const Color(0xFF00897B),
              onTap: () => viewModel.navigate('/recipe-feed'),
              theme: theme,
            ),
          ],
        ),
